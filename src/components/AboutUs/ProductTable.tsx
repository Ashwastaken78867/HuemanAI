...
const content = {
    ...
    features: [
      {
        ...
        desc: "24/7 autonomous voice receptionist for bookings.",
      },
      {
        icon: Sparkles,
        title: "Revenue Intelligence",
        desc: "Real-time PMS sync for total asset optimization.",
      },
      {
        icon: BarChart,
        title: "Insights & Competition",
        desc: "Dynamic pricing to outperform local competitors.",
      },
      {
        icon: Calendar,
        title: "Event Sales Agent",
        desc: "Instant automation for group and event inquiries.",
      }
    ],
    bullets: [
  ...
  marketing: {
    ...
    features: [
      {
        icon: Search,
        title: "SEO Marketing Agent",
        desc: "Autonomous content and ranking optimization.",
      },
      {
        icon: Star,
        title: "Reputation & Conversion",
        desc: "Instant review management to drive guest trust.",
      },
      {
        icon: Settings,
        title: "Digital Brand Manager",
        desc: "AI-driven consistency across every touchpoint.",
      },
      {
        icon: MessageCircle,
        title: "Social & Community Agent",
        desc: "24/7 engagement across all digital channels.",
      },
    ],
    bullets: [
    ...
    features: [
      {
        ...
        desc: "Staff chat for instant task and shift updates.",
      },
      {
        icon: Users,
        title: "Talent Lifecycle Agent",
        desc: "Automated hiring, onboarding, and performance.",
      },
      {
        icon: ClipboardList,
        title: "Scheduling Intelligence",
        desc: "Demand-driven shifts with labor cost control.",
      },
      {
        icon: Settings,
        title: "Concierge & Request Agent",
        desc: "AI routing for seamless guest service delivery.",
      },
    ],
     bullets: [
    ...
    features: [
      {
        ...
        desc: "24/7 automated table booking and guest coordination.",
      },
      {
        icon: BarChart,
        title: "Menu Optimization",
        desc: "AI-driven menu engineering and pricing strategies.",
      },
      {
        icon: ChefHat,
        title: "Guest Experience Agent",
        desc: "Personalized dining recommendations and requests.",
      },
      {
        icon: Utensils,
        title: "Inventory Intelligence",
        desc: "Smart ordering and waste reduction automation.",
      },
    ],
      bullets: [
    "Reduced Labor Costs: Optimize schedules to match actual demand.",
...
{/* Tabs — Figma equal segmented */}
<div className="w-full bg-white p-2 rounded-2xl shadow-md mb-12">
  <div className="grid grid-cols-4 gap-2">
    {tabs.map((t) => (
      <button
        key={t.key}
        onClick={() => setActive(t.key as TabKey)}
        className={`h-14 rounded-xl font-semibold text-base transition-all duration-200
          ${
            active === t.key
      ...
      >
        ...
        {/* Content Card */}
        <div className="bg-white rounded-2xl shadow-md p-10 grid lg:grid-cols-2 gap-12">
          {/* LEFT */}
      {/* LEFT */}
<div>
